...
const SETTINGS = [
  ...
  ['arbsEnabled', 'ARBS', 'locked arbs on or off; off, none are opened, held ones still run to settlement or the early unwind'],
  ...
  ['makerQuoting', 'MAKER_QUOTE', 'maker quoting on or off; off, no quotes, held inventory is still settled and re-marked'],
