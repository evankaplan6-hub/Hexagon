...
module.exports = {
  ...
  // mode it only reports: restarting under an order in flight is the operator's call. Since
  // 2026-09-26 the stocks, crypto and options desk's loop (a round every 10s) is held to it too.
